...
elif data_mode == 'DroneCrowd':
    from datasets.DroneCrowd.loading_data import loading_data
    from datasets.DroneCrowd.setting import cfg_data


#------------Prepare Trainer------------
net = cfg.NET
if net in ['MCNN', 'AlexNet', 'VGG', 'VGG_DECODER', 'Res50', 'Res101', 'CSRNet','Res101_SFCN', 'Res101_SFCN_bayesian', 'LinearNet', 'MLP']:
