...
class Res101_SFCN_bayesian(nn.Module):
    def __init__(self, weights='DEFAULT'):
        super(Res101_SFCN_bayesian, self).__init__()
        self.seen = 0
        ...
        res = models.resnet101(weights=weights)
        ...
        self.model = nn.Sequential(self.frontend,
                                   nn.Dropout(0.5),
                                   self.own_reslayer_3,
                                   nn.Dropout(0.5),
                                   self.backend,
